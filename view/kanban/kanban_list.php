...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digikanban/view/kanban_card.php?fromtype=' . $fromtype . '&fromid=' . $fromid, 1).'&action=create', '', $permissiontoadd);
